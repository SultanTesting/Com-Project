...
use App\Http\Controllers\Backend\Vendor\VendorOrdersController;
...
Route::prefix('vendor')
    ...
    ->group(function (){
        ...
        /** Order Routes */
        Route::get('orders', [VendorOrdersController::class, 'index'])->name('orders.index');
        Route::get('orders/show/{id}', [VendorOrdersController::class, 'show'])->name('orders.show');
        Route::get('orders/status', [VendorOrdersController::class, 'status'])->name('orders.status');
    });
