    <!--============================
        MAIN MENU START [ PCs Nav Version ]
    ==============================-->
                    ...
                    <div class="relative_contect d-flex">
                        ...
                        <ul class="wsus_menu_cat_item show_home toggle_menu">
                            ...
                            @foreach ($categories_view as $category )
                                ...
                                <li>
                                    <a class="{{count($category->activeSubCategory) > 0 ? 'wsus__droap_arrow' : ''}}" href="#"><i class="{{$category->icon}}"></i> {{$category->name}} </a>

                                    <ul class="{{count($category->activeSubCategory) > 0 ? 'wsus_menu_cat_droapdown' : ''}}">
                                        @foreach ($category->activeSubCategory as $subCategory)
                                            <li>
                                                <a href="#">{{$subCategory->name}} <i
                                                class="{{count($subCategory->activeChildCategories) > 0 ? 'fas fa-angle-right' : ''}}"></i>
                                                </a>
                                                <ul
                                                class="{{count($subCategory->activeChildCategories) > 0 ? 'wsus__sub_category' : ''}}">
    ...
    ==============================-->
    <!--============================
        MOBILE MENU START [ Mobile Nav Version ]
    ==============================-->
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <ul class="wsus_mobile_menu_category">
                            ...
                            @foreach ($categories_view as $category )
                                <li>
                                    <a href="#"
                                        class="{{count($category->activeSubCategory) > 0 ? 'accordion-button' : ''}} collapsed"
