...
@section('content')
    ...
    ==============================-->
        @include('frontend.home.sections.electronic-slider')
    <!--============================
        ELECTRONIC PART END
    ==============================-->
    ...
    <!--============================
        ELECTRONIC PART START
    ==============================-->
        @include('frontend.home.sections.fashion-slider')
    <!--============================
        ELECTRONIC PART END
    ==============================-->
    ...
    <!--============================
        LARGE BANNER  START
    ==============================-->
        @include('frontend.home.sections.week-deal')
    <!--============================
        LARGE BANNER  END
    ==============================-->
    ...
    ==============================-->
        @include('frontend.home.sections.week-best')
    <!--============================
