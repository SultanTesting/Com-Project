<div class="dashboard_sidebar">
    ...
    <a href="{{route('home')}}" class="dash_logo"><img src="{{ asset('frontend/images/vendor-dash.png') }}" alt="logo" class="img-fluid"></a>
    <p class="text-center fs-6 text-secondary fw-bold">Vendor Dashboard</p>

    <ul class="dashboard_link">

      <li><a class="{{Route::is('vendor.dashboard') ? 'active' : ''}}"
      ...
      <li><a class="{{Route::is('vendor.profile') ? 'active' : ''}}"
