                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.vendor-profile.update', $vendor->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <x-input-error :messages="$errors->get('name')" class="mb-2 alert-danger" />
                                </div>

                                <div class="form-group">
                                    <label class="form-label">Email</label>
                                    <input type="text" name="email" value="{{$vendor->email}}" class="form-control">
                                    <x-input-error :messages="$errors->get('email')" class="mb-2 alert-danger" />
                                </div>

                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="phone" value="{{$vendor->phone}}" class="form-control">
                                    <x-input-error :messages="$errors->get('phone')" class="mb-2 alert-danger" />
                                </div>

                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" name="address" value="{{$vendor->address}}" class="form-control">
                                    <x-input-error :messages="$errors->get('address')" class="mb-2 alert-danger" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-input-error :messages="$errors->get('shop_description')" class="mb-2 alert-danger" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-input-error :messages="$errors->get('facebook')" class="mb-2 alert-danger" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-input-error :messages="$errors->get('x')" class="mb-2 alert-danger" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-input-error :messages="$errors->get('instagram')" class="mb-2 alert-danger" />
                                </div>
                                ...
                                <div class="form-goup">
                                    ...
                                    <x-input-error :messages="$errors->get('store_status')" class="mb-2 alert-danger" />
                                </div>
